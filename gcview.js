  ...
  createObjectFromGCode = function(gcode) {
    ...
    var parser = new this.GCodeParser({
      ...
      // These take no arguments
      {
        ...
        M3: function() {
          if (!cofg.extraObjects['m3']) cofg.extraObjects['m3'] = [];
          cofg.extraObjects['m3'].push([lastLine.x, lastLine.y, lastLine.z]);
        },
        M4: function() {
          if (!cofg.extraObjects['m4']) cofg.extraObjects['m4'] = [];
          cofg.extraObjects['m4'].push([lastLine.x, lastLine.y, lastLine.z]);
        },
        M5: function() {
          if (!cofg.extraObjects['m5']) cofg.extraObjects['m5'] = [];
          cofg.extraObjects['m5'].push([lastLine.x, lastLine.y, lastLine.z]);
        },
        M6: function(args) {
          if (!cofg.extraObjects['m6']) cofg.extraObjects['m6'] = [];
          cofg.extraObjects['m6'].push([lastLine.x, lastLine.y, lastLine.z]);
        },
        M7: function() {
          if (!cofg.extraObjects['m7']) cofg.extraObjects['m7'] = [];
          cofg.extraObjects['m7'].push([lastLine.x, lastLine.y, lastLine.z]);
        },
        M8: function() {
          if (!cofg.extraObjects['m8']) cofg.extraObjects['m8'] = [];
          cofg.extraObjects['m8'].push([lastLine.x, lastLine.y, lastLine.z]);
        },
    ...
    var data = {
      ...
      //lines: lines,
      extraObjects: this.extraObjects, // ⬅️ Add this line
      inch: false,
